...
  // 1. ❗️ ОСЬ ВИРІШЕННЯ ПРОБЛЕМИ "ЗСУНУТЕ В ПРАВО":
...
  
  // 2. Початкова тривалість анімації = 0 секунд.
  // Це запобігає "повільному" руху колеса при завантаженні.
...
  // 4. "Телепортуємо" колесо назад на базову позицію після прокрутки
